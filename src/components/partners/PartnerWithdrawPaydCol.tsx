...
import WithdrawEditRow from '../withdraws/not-payd/WithdrawEditRow'
import WithdrawEditPartnerId from '../withdraws/not-payd/WithdrawEditPartnerId'
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger } from '../ui/dropdown-menu'
import WithdrawEditForm from '../withdraws/not-payd/WithdrawEditForm'
...
export const columns: ColumnDef<IWithdraw>[] = [
  ...
  },
	{
		...
		cell: ({ row }) => {
			const withdraw = row.original
			return (
				<div className='lowercase text-blue1 text-center'>
